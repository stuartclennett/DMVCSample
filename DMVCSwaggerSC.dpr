...
uses
  ...
  MVCFramework.Signal,
  PersonEntityU in 'PersonEntityU.pas',
  PersonServiceU in 'PersonServiceU.pas',
  ControllerU in 'ControllerU.pas',
  WebModuleU in 'WebModuleU.pas' {SCDemoWebMod: TWebModule},
  uChaptersControllers in 'uChaptersControllers.pas',
  uOcChapterEntity in 'uOcChapterEntity.pas',
  uBaseEntity in 'uBaseEntity.pas',
  uOcAPIController in 'uOcAPIController.pas',
  uJWTUtils in 'uJWTUtils.pas',
  uOcUserEntity in 'uOcUserEntity.pas',
  uOCConstants in 'uOCConstants.pas';
